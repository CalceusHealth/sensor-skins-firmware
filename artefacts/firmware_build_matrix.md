...
|---|---|---|---|---|---|---|---|---|---|---|---|
| built — latest (sleep v2; bench-verify vbat first) | `v2.0.60` | `lhs` | `stream` | `sleep` | `BINARY_V2 v3` | `100Hz`* | `GAIN1_2` | `BINARY_V2` | `artefacts/out/stream_sleep_lhs_v2.0.60_sensorskins.zip` | `8c6210cf062199d07e00c9260597a4b1daf2a29a64f3263a440b7c7b968bb6a1` | `76e1621` |
| built — latest (sleep v2; bench-verify vbat first) | `v2.0.60` | `rhs` | `stream` | `sleep` | `BINARY_V2 v3` | `100Hz`* | `GAIN1_2` | `BINARY_V2` | `artefacts/out/stream_sleep_rhs_v2.0.60_sensorskins.zip` | `c058b8323f675de58fec0990e3c0bec3dc2ef466ea4d03aa1e22f4608e12de7e` | `76e1621` |
