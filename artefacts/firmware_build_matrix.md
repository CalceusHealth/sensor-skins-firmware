...
- **Latest build: `v2.0.58` (stream / `BINARY_V2` v3) — SEN-68 IMU in the stream, always-on.** Stream VERSION 2→3: sensor row 74→76 B (temp moved out to a new frame_type 2; `acc[3]`+`gyro[3]` int16 appended; still 3 rows/frame). LSM6DSM read every frame at 208 Hz ODR. ⚠️ **Breaking wire change — needs a v3 host decoder (SEN-90 mobile / SEN-89 desktop / SEN-91 web) before it can be recorded; do not flash for real sessions until then** (the current app would misparse v3). Built stream LHS+RHS (`5ae0931`). Includes the SEN-59 v2.0.57 divider fix (true single-foot 100 Hz); dual-foot contention is tracked in SEN-92 (mobile).
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| built — latest (SEN-68 IMU v3) | `v2.0.58` | `lhs` | `stream` | `sleep` | `BINARY_V2 v3` | `100Hz`* | `GAIN1_2` | `BINARY_V2` | `artefacts/out/stream_sleep_lhs_v2.0.58_sensorskins.zip` | `fd3c7c679d403881a8c5e6ea9aacc111b32d6999f94c60ff1bf9dce5d4346775` | `5ae0931` |
| built — latest (SEN-68 IMU v3) | `v2.0.58` | `rhs` | `stream` | `sleep` | `BINARY_V2 v3` | `100Hz`* | `GAIN1_2` | `BINARY_V2` | `artefacts/out/stream_sleep_rhs_v2.0.58_sensorskins.zip` | `07fb882d1b97324e7391a7282a8dc97311e174324f807d35169b262fe9936ada` | `5ae0931` |
