...
|---|---|---|---|---|---|---|---|---|---|---|---|
| built — latest (IMU v3 + battery) | `v2.0.59` | `lhs` | `stream` | `sleep` | `BINARY_V2 v3` | `100Hz`* | `GAIN1_2` | `BINARY_V2` | `artefacts/out/stream_sleep_lhs_v2.0.59_sensorskins.zip` | `a3bff9ffeaa0a184de32106df2c3cad5a2fa55bc4a55bad29c673ecc856810e9` | `d698fb6` |
| built — latest (IMU v3 + battery) | `v2.0.59` | `rhs` | `stream` | `sleep` | `BINARY_V2 v3` | `100Hz`* | `GAIN1_2` | `BINARY_V2` | `artefacts/out/stream_sleep_rhs_v2.0.59_sensorskins.zip` | `0c6d895c467a0cc4f7573433317abc9f54be7b505467d00496cc0646041e4636` | `d698fb6` |
