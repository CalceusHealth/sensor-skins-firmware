...
- **Latest build: `v2.0.55` (stream / `BINARY_V2`)** — SEN-59 round 1: BLE transport tuning to close the ~14% frame loss at 100 Hz. Connection interval 10–20 ms → **7.5–15 ms**, slave latency 1 → **0**, and a **non-blocking stream TX** (`ble_reid_tx_stream`) so a full SoftDevice queue no longer busy-waits and stalls the 10 ms loop (the actual mechanism behind the dropped rows). Stream format still v2 (IMU/v3 is SEN-68, comes next). Built stream LHS+RHS; **awaiting a walk-test** against the v2.0.53 86 Hz baseline. If loss is still >2%, round 2 = deep HVN TX queue + multiple notifications per connection event (needs a SoftDevice RAM bump + hardware validation).
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| built — latest (SEN-59 r1) | `v2.0.55` | `lhs` | `stream` | `sleep` | `BINARY_V2` | `100Hz`* | `GAIN1_2` | `BINARY_V2` | `artefacts/out/stream_sleep_lhs_v2.0.55_sensorskins.zip` | `d425892b22a4e0d4038e54e53f54d38f8316b5349e4f67ea2dc0c0d4446f1c40` | `8a42057` |
| built — latest (SEN-59 r1) | `v2.0.55` | `rhs` | `stream` | `sleep` | `BINARY_V2` | `100Hz`* | `GAIN1_2` | `BINARY_V2` | `artefacts/out/stream_sleep_rhs_v2.0.55_sensorskins.zip` | `50d7fa579cb450126657903fe672f0b70217ae562d1dda89f95fdb25d10fe170` | `8a42057` |
