...
#define DEVICE_FW_VERSION	0x00020001
...
#define FSR_SLEEP_THRESHOLD		100
#define FSR_SLEEP_NUM			20 // this many under the threshold
#define SLEEP_NUM_MEAS			600 // for this many consecutive measurements
#define SLEEP_CHECK_EVERY_MS	30000 // check every N after sleeping
...
#define MSG_TX_BUFFER_SIZE				1024
#define MSG_RX_BUFFER_SIZE				256
